    ...
    try {
        ...
        if (razorpay_signature === expectedSign) {
            Profile.findOneAndUpdate(
                ...
                {$set:{'applications.currentApplication.amountPaid':true,'applications.currentApplication.paymentId':razorpay_payment_id,'applications.allApplications.0.amountPaid':true,'applications.allApplications.0.paymentId':razorpay_payment_id}},
